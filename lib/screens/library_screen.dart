  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Library Help', style: TextStyle(color: AppColors.textMain, fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: TextStyle(color: AppColors.textMain.withOpacity(0.6)),
              ...
              Text('Quick Actions', style: TextStyle(color: AppColors.textMain, fontSize: 18, fontWeight: FontWeight.bold)),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: NetworkImage('https://images.unsplash.com/photo-1524813686514-a57563d77965?w=800'), // Map placeholder
                    fit: BoxFit.cover,
                  ),
                ),
                child: Stack(
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: AppColors.white24.withOpacity(0.3),
              ...
              Text('Frequently Asked Questions', style: TextStyle(color: AppColors.textMain, fontSize: 18, fontWeight: FontWeight.bold)),
              const SizedBox(height: 16),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(title, style: TextStyle(color: AppColors.textMain, fontWeight: FontWeight.bold, fontSize: 16)),
  ...
  Widget _buildFAQItem(String question) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text(question, style: TextStyle(color: AppColors.textMain, fontWeight: FontWeight.w500)),
          Icon(Icons.keyboard_arrow_down, color: AppColors.textGray),
        ],
      ),
    );
  }
