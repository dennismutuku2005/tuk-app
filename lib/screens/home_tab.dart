            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(
                      colors: [Color(0xFFD1A443), Color(0xFF2E7D5C)], // Gold to Green
                      ...
                      children: [
                        ...
                        Expanded(
                          child: _buildQuickActionItem(
                            ...
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const ConfessScreen()),
                            ),
                          ),
                        ),
                      ],
                        ...
                        Expanded(
                          child: _buildQuickActionItem(
                            ...
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => const FeesTab()),
                              );
                            },
                          ),
                        ),
                      ...
                      children: [
                        Expanded(
                          child: _buildQuickActionItem(
                            ...
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const ChannuaTab()),
                            ),
                          ),
                        ),
                        const SizedBox(width: 12),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      const Icon(FontAwesomeIcons.quoteLeft, color: AppColors.primaryGold, size: 20),
                      const SizedBox(height: 12),
                      Text(
                      ...
                      Row(
                        ...
                        children: [
                          const CircleAvatar(
                            backgroundImage: NetworkImage('https://upload.wikimedia.org/wikipedia/commons/1/14/Nelson_Mandela-2008_%28edit%29.jpg'),
                            radius: 12,
                          ),
